...
const ICONS: Record<IconName, IconDef> = {
  ...
  starFillSmall: { d: ["M12 3l1.38 5.67 5.62 1.33-5.62 1.33L12 17l-1.38-5.67L5 12l5.62-1.33z"], fill: true },
  volume: {
  ...
  drum: { c: [[12, 12, 8.2], [12, 12, 3.2]], d: ["M12 3.8v1.4M12 18.8v1.4M3.8 12h1.4M18.8 12h1.4"] },
  ...
  mosque: {
    d: [
      "M4 20.4V12l3-2.6V6.2M20 20.4V12l-3-2.6V6.2",
      "M7 20.4v-5.2a5 5 0 0 1 10 0v5.2",
      "M2.6 20.4h18.8",
      "M12 6.2V3.4M12 3.4c1.2 0 1.8.8 1.8 1.6",
    ],
  },
  compass: { c: [[12, 12, 8.4]], d: ["M15.2 8.8l-1.8 4.6-4.6 1.8 1.8-4.6z"] },
  download: { d: ["M12 3.8v11.4", "M8 11.4l4 3.8 4-3.8", "M4.6 18.4v1.2a1.6 1.6 0 0 0 1.6 1.6h11.6a1.6 1.6 0 0 0 1.6-1.6v-1.2"] },
  ...
  bell: { d: ["M6.4 10.4a5.6 5.6 0 0 1 11.2 0c0 4 1.6 5.2 1.6 5.2H4.8s1.6-1.2 1.6-5.2z", "M10.2 18.8a2 2 0 0 0 3.6 0"] },
  ...
  chart: { d: ["M4 20h16", "M6.6 20v-6.4", "M11.4 20V6.6", "M16.2 20v-9.2", "M20.4 20V9.8"], sw: 1.8 },
